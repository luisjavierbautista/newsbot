...
import { BarChart3, Network, TrendingUp, Users, ArrowRight, Sparkles, CheckCircle } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6">
        ...
        <Link
          to="/facts"
          className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-emerald-600/20 to-green-900/30 border border-emerald-500/20 p-4 sm:p-5 hover:border-emerald-500/40 transition-all duration-300"
        >
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-white">Hechos del Día</h3>
              </div>
              <p className="text-sm text-gray-400 leading-relaxed">
                Resumen de hechos clave extraídos y verificados por IA
              </p>
            </div>
            <ArrowRight className="w-5 h-5 text-emerald-400 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all flex-shrink-0 mt-1" />
          </div>
          <div className="flex items-center gap-3 mt-3 pt-3 border-t border-emerald-500/10">
            <div className="flex items-center gap-1.5 text-xs text-emerald-300">
              <CheckCircle className="w-3.5 h-3.5" />
              <span>Verificado con IA</span>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Distribución de sesgo, tono y entidades más mencionadas
              </p>
            </div>
        ...
        >
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Conexiones entre personas, lugares y organizaciones
              </p>
            </div>
          ...
          <div className="flex items-center gap-3 mt-3 pt-3 border-t border-cyan-500/10">
            ...
            <span className="text-xs text-cyan-300">Interactivo</span>
          </div>
        </Link>
      </div>
